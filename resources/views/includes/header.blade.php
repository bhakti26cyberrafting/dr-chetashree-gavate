      ...
      <div class="container">
        <div class="navbar">
          ...
          <div class="nav-actions">
            <button class="btn btn-outline" type="button" onclick="window.location.href='tel:+918452903111'">
              Call Clinic
            </button>
            <a href="#contact" class="btn btn-primary">
              Book Appointment
            </a>
            <button class="nav-toggle" type="button" aria-label="Toggle navigation" onclick="toggleMobileNav(this)">
              <span></span>
            </button>
          </div>
        </div>
        <div class="nav-menu-mobile" id="mobileNav">
          ...
          <a href="#contact" class="btn btn-primary " onclick="closeMobileNav()">Book Appointment</a>
        </div>
      </div>
    </header>